import { IconCardColors, IconCardProps } from '@/components/home/cards';
import {
  UserCheck,
  CheckSquare,
  Edit3,
...
export interface homePageConfigType {
  botInvite: string,
  guildInvite: string,
  appeal: IconCardProps[],
  feature: IconCardProps[],
}
  ...
  appeal: [
    {
      ...
      icon: DollarSign,
      color: IconCardColors.Secondary,
    },
    {
      title: 'ユーザーの意見を大切に',
